...
class EachFieldAsMessageInflaterTest : NetworkedTestAbstract() {
    ...
    fun testStats() {
        ...
        assertFieldNames(
            ...
            "toUdpMaxBytes", "toUdpMessages", "toUdpTotalBytes",
            "toTcpMaxBytes", "toTcpMessages", "toTcpTotalBytes",
            "toFileMaxBytes", "toFileMessages", "toFileTotalBytes",
            "toShellMaxBytes", "toShellMessages", "toShellTotalBytes",
            ...
            "queueMaxSize", "queueOverflows", "queueChunksCreated", "uptimeSeconds", "messagesReceived", "messagesSent", "configReloads", "unparsedDropped",
    ...
    fun testStatsInfluxizer() {
        ...
        assertEquals(listOf(
            ...
            "beholder,tag=tagval messagesSent=N",
            ...
            "beholder,tag=tagval toFileMaxBytes=N",
            "beholder,tag=tagval toFileMessages=N",
            "beholder,tag=tagval toFileTotalBytes=N",
            "beholder,tag=tagval toShellMaxBytes=N",
            "beholder,tag=tagval toShellMessages=N",
            "beholder,tag=tagval toShellTotalBytes=N",
            "beholder,tag=tagval toTcpMaxBytes=N",
            "beholder,tag=tagval toTcpMessages=N",
            "beholder,tag=tagval toTcpTotalBytes=N",
            "beholder,tag=tagval toUdpMaxBytes=N",
            "beholder,tag=tagval toUdpMessages=N",
            "beholder,tag=tagval toUdpTotalBytes=N",
